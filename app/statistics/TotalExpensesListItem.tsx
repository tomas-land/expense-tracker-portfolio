    ...
    <li className={s.list_item} >
      <div className={s.item_header}>
        ...
        <div className={s.amount_radio}>
          <div className={s.amount}>- {totalAmountByCategory} <span className={s.prev_month_amount}> / {previousMonthTotalAmountByCategory === 0 ? 0 : - previousMonthTotalAmountByCategory}</span> </div>
